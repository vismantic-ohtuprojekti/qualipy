...
Usage
-----
Celery can be used to process multiple images at the same time, by dividing the filtering process between workers. To start, you must first configure the celeryconfig.py to include correct broker-address and task-modules, for example if you are using Redis-server::
