...
This saliency map is binarized by marking all pixels with value over 120 as white and the rest black. The areas of the produced white blobs are calculated, and if multiple blobs big enough in comparison to the biggest blob are found, the image is considered to have multiple salient regions.
